...
pub static DEFAULT_BATTLE_CONSTANTS: LazyLock<BattleConstants> =
    LazyLock::new(BattleConstants::defaults);

/// Default ships constants (hardcoded, no game files needed).
pub static DEFAULT_SHIPS_CONSTANTS: LazyLock<ShipsConstants> =
    LazyLock::new(ShipsConstants::defaults);

/// Default common constants (hardcoded, no game files needed).
pub static DEFAULT_COMMON_CONSTANTS: LazyLock<CommonConstants> =
    LazyLock::new(CommonConstants::defaults);
    ...
    pub fn defaults() -> Self {
        Self {
            ...
            entity_states: HashMap::from([
                ...
                (
                    113,
                    Cow::Borrowed("SHIP_PARAMS_CHANGE_BY_ATBA_ACCURACY_PERK"),
                ),
                ...
                (
                    121,
                    Cow::Borrowed("SHIP_PARAMS_CHANGE_BY_ARTILLERY_FIRE_MODE"),
                ),
                (122, Cow::Borrowed("SHIP_PARAMS_CHANGE_BY_RAGE_MODE")),
                (123, Cow::Borrowed("SHIP_PARAMS_CHANGE_BY_CONSUMABLES")),
                (
                    124,
                    Cow::Borrowed("SHIP_PARAMS_CHANGE_BY_NOT_SPECIAL_MODULES"),
                ),
                (
                    125,
                    Cow::Borrowed("SHIP_PARAMS_CHANGE_BY_CONSUMABLE_LOCKER"),
                ),
                (
                    126,
                    Cow::Borrowed("SHIP_PARAMS_CHANGE_BY_ANTI_ABUSE_SYSTEM"),
                ),
    ...
    pub fn defaults() -> Self {
        Self {
            ...
            consumable_types: HashMap::from([
                ...
                (
                    4,
                    Cow::Borrowed(Consumable::MainBatteryReloadBooster.name()),
                ),
